...
<head>
    ...
    <script src="${pageContext.request.contextPath}/resources/moment/moment-with-locales.js"></script>
    <script src="${pageContext.request.contextPath}/resources/bootstrap/bootstrap-datetimepicker.min.js"></script>
    <link type="text/css" rel="stylesheet"
          href="${pageContext.request.contextPath}/resources/bootstrap/bootstrap-datetimepicker.min.css">
    <!-- Font Awesome JS -->
